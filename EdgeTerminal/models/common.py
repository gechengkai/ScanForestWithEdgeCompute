...
#         x = self.channel_shuffle(x, 2) # gck add 
#         return x
...
class MBConvBlock_ECA_Shuffle(nn.Module):
    def __init__(self, inp, final_oup, k, s, expand_ratio, drop_connect_rate, has_eca=False, has_shuf=True):
        super(MBConvBlock_ECA_Shuffle, self).__init__()
        ...
        self.stride = s
        self.expand_ratio = expand_ratio
        self.has_eca = has_eca
        self.has_shuf = has_shuf
        self.id_skip = True  # skip connection and drop connect
        se_ratio = 0.25
